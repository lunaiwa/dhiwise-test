...
const LoginPage = () => {
  return (
    <>
      <div className="bg-white-A700 flex flex-col font-altehaasgrotesk sm:gap-10 md:gap-10 gap-[1128px] justify-end mx-auto md:pr-10 sm:pr-5 pr-[97px] pt-[97px] w-full">
        <div className="flex flex-col items-center mt-3.5 md:pl-10 sm:pl-5 pl-[97px] w-full">
          <div className="flex flex-col justify-start">
            ...
            <Text
              className="md:ml-[0] ml-[720px] mt-24 md:text-5xl text-[90px] text-center text-red-400"
